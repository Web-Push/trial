...
$intermediate_certificate_path = "intermediate.pem";     // Change this to the path where the intermediate certificate is located
$certificate_password = "password"; // Change this to the certificate's import password
